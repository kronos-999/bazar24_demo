  ...
  <div class="bg-white">
          ...
          <TransitionChild as="template" enter="transition ease-in-out duration-300 transform" enter-from="-translate-x-full" enter-to="translate-x-0" leave="transition ease-in-out duration-300 transform" leave-from="translate-x-0" leave-to="-translate-x-full">
            <DialogPanel class="relative max-w-xs w-full flex flex-col overflow-y-auto bg-white pb-12 shadow-xl">
              <div class="flex px-4 pb-2 pt-5">
                <button type="button" class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 -m-2" @click="mobileMenuOpen = false">
              ...
              <div class="border-t border-gray-200 px-4 py-6 space-y-6">
                ...
                <form>
                  <div class="inline-block">
                    ...
                    <div class="group relative border-transparent rounded-md -ml-2 focus-within:ring-2 focus-within:ring-white">
                      <select id="mobile-currency" name="currency" class="flex items-center border-transparent rounded-md bg-none py-0.5 pl-2 pr-5 text-sm font-medium text-gray-700 focus:border-transparent group-hover:text-gray-800 focus:outline-none focus:ring-0">
    ...
    <div class="relative bg-gray-900">
            ...
            <div class="mx-auto h-10 max-w-7xl flex items-center justify-between px-4 lg:px-8 sm:px-6">
              ...
              <form>
                <div>
                  ...
                  <div class="group relative border-transparent rounded-md bg-gray-900 -ml-2 focus-within:ring-2 focus-within:ring-white">
                    <select id="desktop-currency" name="currency" class="flex items-center border-transparent rounded-md bg-gray-900 bg-none py-0.5 pl-2 pr-5 text-sm font-medium text-white focus:border-transparent group-hover:text-gray-100 focus:outline-none focus:ring-0">
                      <option v-for="currency in currencies" :key="currency">
                        {{ currency }}
                      </option>
                    </select>
                        ...
                        <Popover v-for="category in navigation.categories" :key="category.name" v-slot="{ open }" class="flex">
                          <div class="relative flex">
                            <PopoverButton class="relative z-10 flex items-center justify-center text-sm font-medium text-white transition-colors duration-200 ease-out">
                              {{ category.name }}
                              <span class="absolute inset-x-0 h-0.5 transition duration-200 ease-out -bottom-px" :class="[open ? 'bg-white' : '']" aria-hidden="true" />
                            </PopoverButton>
                          </div>
      ...
      <div class="relative mx-auto max-w-3xl flex flex-col items-center px-6 py-32 text-center lg:px-0 sm:py-64">
        ...
        <a href="#" class="mt-8 inline-block border border-transparent rounded-md bg-white px-8 py-3 text-base font-medium text-gray-900 hover:bg-gray-100">Shop New Arrivals</a>
      </div>
    </div>
    ...
    <main>
        ...
        <div class="mt-4 flow-root">
          <div class="-my-2">
            <div class="relative box-content h-80 overflow-x-auto py-2 xl:overflow-visible">
              <div class="absolute min-w-screen-xl flex px-4 xl:relative xl:grid xl:grid-cols-5 xl:gap-x-8 space-x-8 lg:px-8 sm:px-6 xl:px-0 xl:space-x-0">
                <a v-for="category in categories" :key="category.name" :href="category.href" class="relative h-80 w-56 flex flex-col overflow-hidden rounded-lg p-6 xl:w-auto hover:opacity-75">
                  <span aria-hidden="true" class="absolute inset-0">
                    <img :src="category.imageSrc" alt="" class="h-full w-full object-cover object-center">
                  </span>
                  <span aria-hidden="true" class="absolute inset-x-0 bottom-0 h-2/3 from-gray-800 bg-gradient-to-t opacity-50" />
        ...
        <div class="relative overflow-hidden rounded-lg">
          ...
          <div class="relative bg-gray-900 bg-opacity-75 px-6 py-32 lg:px-16 sm:px-12 sm:py-40">
            <div class="relative mx-auto max-w-3xl flex flex-col items-center text-center">
              ...
              <a href="#" class="mt-8 block w-full border border-transparent rounded-md bg-white px-8 py-3 text-base font-medium text-gray-900 sm:w-auto hover:bg-gray-100">Shop Workspace</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- Collection section -->
      <section aria-labelledby="collection-heading" class="mx-auto max-w-xl px-4 pt-24 lg:max-w-7xl lg:px-8 sm:px-6 sm:pt-32">
        ...
        <div class="mt-10 lg:grid lg:grid-cols-3 lg:gap-x-8 space-y-12 lg:space-y-0">
          <a v-for="collection in collections" :key="collection.name" :href="collection.href" class="group block">
            <div aria-hidden="true" class="aspect-w-3 aspect-h-2 lg:aspect-w-5 lg:aspect-h-6 overflow-hidden rounded-lg group-hover:opacity-75">
        ...
        <div class="relative overflow-hidden rounded-lg">
          ...
          <div class="relative bg-gray-900 bg-opacity-75 px-6 py-32 lg:px-16 sm:px-12 sm:py-40">
            <div class="relative mx-auto max-w-3xl flex flex-col items-center text-center">
              ...
              <a href="#" class="mt-8 block w-full border border-transparent rounded-md bg-white px-8 py-3 text-base font-medium text-gray-900 sm:w-auto hover:bg-gray-100">Shop Focus</a>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="mt-12 md:mt-16 xl:mt-0">
            ...
            <form class="mt-2 flex sm:max-w-md">
              ...
              <div class="ml-4 flex-shrink-0">
                <button type="submit" class="w-full flex items-center justify-center border border-transparent rounded-md bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:ring-offset-gray-900">
                  Sign up
                </button>
              </div>
            </form>
