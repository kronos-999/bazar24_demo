...
<template>
  <main class="bg-white px-4 pb-24 pt-16 lg:px-8 lg:py-32 sm:px-6 sm:pt-24">
    <div class="mx-auto max-w-3xl">
      ...
      <section aria-labelledby="order-heading" class="mt-10 border-t border-gray-200">
        ...
        <div v-for="product in products" :key="product.id" class="flex border-b border-gray-200 py-10 space-x-6">
          <img
          ...
          <div class="flex flex-auto flex-col">
            ...
            <div class="mt-6 flex flex-1 items-end">
              <dl class="flex text-sm space-x-4 divide-x divide-gray-200 sm:space-x-6">
                <div class="flex">
        ...
        <div class="sm:ml-40 sm:pl-6">
          ...
          <dl class="border-t border-gray-200 pt-10 text-sm space-y-6">
