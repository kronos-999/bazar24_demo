...
<template>
  <div class="bg-white">
    ...
    <main class="mx-auto max-w-7xl px-4 py-16 lg:px-8 sm:px-6 sm:py-24">
      ...
      <section aria-labelledby="products-heading" class="mt-8">
        ...
        <div class="space-y-24">
          <div
            ...
            class="grid grid-cols-1 text-sm sm:grid-cols-12 sm:grid-rows-1 lg:gap-x-8 md:gap-x-8 sm:gap-x-6"
          >
            <div class="md:col-span-5 md:row-span-2 sm:col-span-4 md:row-end-2">
            ...
            <div class="mt-6 sm:col-span-7 md:row-end-1 sm:mt-0">
            ...
            <div class="md:col-span-7 sm:col-span-12">
              <dl
                class="grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 md:py-10 sm:py-6"
              >
                <div>
              ...
              <div class="mt-6">
                ...
                <div class="grid-cols-4 mt-6 hidden font-medium text-gray-600 sm:grid">
      ...
      <section aria-labelledby="summary-heading" class="mt-24">
        ...
        <div class="rounded-lg bg-gray-50 px-6 py-6 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-0 lg:py-8">
          <dl class="grid grid-cols-1 gap-6 text-sm lg:col-span-5 sm:grid-cols-2 md:gap-x-8 lg:pl-8">
            <div>
              <dt class="font-medium text-gray-900">
                Billing address
              </dt>
          ...
          <dl class="mt-8 text-sm lg:col-span-7 lg:mt-0 divide-y divide-gray-200 lg:pr-8">
