...
<template>
  <div class="bg-white">
    ...
    <header class="relative overflow-hidden">
                          ...
                          <div class="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                            ...
                            <div class="grid row-start-1 grid-cols-3 gap-x-8 gap-y-10 text-sm">
                              <div v-for="section in category.sections" :key="section.name">
                                ...
                                <ul
                                  role="list" :aria-labelledby="`${section.name}-heading`"
      ...
      <!-- Hero section -->
      <div class="pb-80 pt-16 lg:pb-48 lg:pt-40 sm:pb-40 sm:pt-24">
        <div class="relative mx-auto max-w-7xl px-4 sm:static lg:px-8 sm:px-6">
          ...
          <div>
            <div class="mt-10">
                ...
                >
                  <div class="flex items-center space-x-6 lg:space-x-8">
                    <div class="grid grid-cols-1 flex-shrink-0 gap-y-6 lg:gap-y-8">
                      <div class="h-64 w-44 overflow-hidden rounded-lg lg:opacity-100 sm:opacity-0">
                        <img
                    ...
                    <div class="grid grid-cols-1 flex-shrink-0 gap-y-6 lg:gap-y-8">
                      <div class="h-64 w-44 overflow-hidden rounded-lg">
                        <img
                          src="https://tailwindui.com/img/ecommerce-images/home-page-03-hero-image-tile-06.jpg" alt=""
                          class="h-full w-full object-cover object-center"
                        >
                      </div>
                      <div class="h-64 w-44 overflow-hidden rounded-lg">
                        <img
                          src="https://tailwindui.com/img/ecommerce-images/home-page-03-hero-image-tile-07.jpg" alt=""
                          class="h-full w-full object-cover object-center"
                        >
                      </div>
                    </div>
              ...
              <a
                href="#"
                class="inline-block border border-transparent rounded-md bg-indigo-600 px-8 py-3 text-center font-medium text-white hover:bg-indigo-700"
              >Shop
                Collection</a>
            </div>
          </div>
    ...
    <main>
      ...
      <section aria-labelledby="category-heading" class="bg-gray-50">
        <div class="mx-auto max-w-7xl px-4 py-24 lg:px-8 sm:px-6 sm:py-32">
          ...
          <div class="grid grid-cols-1 mt-6 gap-y-6 sm:grid-cols-2 sm:grid-rows-2 lg:gap-8 sm:gap-x-6">
            <div class="group aspect-w-2 aspect-h-1 sm:aspect-h-1 sm:aspect-w-1 overflow-hidden rounded-lg sm:row-span-2">
              <img
                src="https://tailwindui.com/img/ecommerce-images/home-page-03-featured-category.jpg"
                alt="Two models wearing women's black cotton crewneck tee and off-white cotton crewneck tee."
                class="object-cover object-center group-hover:opacity-75"
              >
              <div aria-hidden="true" class="from-transparent to-black bg-gradient-to-b opacity-50" />
            ...
            <div class="group aspect-w-2 aspect-h-1 sm:aspect-none overflow-hidden rounded-lg sm:relative sm:h-full">
              <img
                src="https://tailwindui.com/img/ecommerce-images/home-page-03-category-01.jpg"
                alt="Wooden shelf with gray and olive drab green baseball caps, next to wooden clothes hanger with sweaters."
                class="object-cover object-center sm:absolute sm:inset-0 sm:h-full sm:w-full group-hover:opacity-75"
              >
              <div
                aria-hidden="true"
                class="from-transparent to-black bg-gradient-to-b opacity-50 sm:absolute sm:inset-0"
              />
      ...
      <section aria-labelledby="cause-heading">
        <div class="relative bg-gray-800 px-6 py-32 lg:px-16 sm:px-12 sm:py-40">
      ...
      <section aria-labelledby="favorites-heading">
        <div class="mx-auto max-w-7xl px-4 py-24 lg:px-8 sm:px-6 sm:py-32">
          ...
          <div class="grid grid-cols-1 mt-6 gap-y-10 sm:grid-cols-3 lg:gap-x-8 sm:gap-x-6 sm:gap-y-0">
            <div v-for="favorite in favorites" :key="favorite.id" class="group relative">
              <div
                class="sm:aspect-w-2 sm:aspect-h-3 h-96 w-full overflow-hidden rounded-lg sm:h-auto group-hover:opacity-75"
              >
          ...
          <div class="bg-gray-800">
            <div class="mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
              <div class="relative pb-16 pt-48 sm:pb-24">
                ...
                <div class="absolute left-1/2 transform -top-32 sm:top-6 -translate-x-1/2 sm:translate-x-0">
                  <div class="ml-24 min-w-max flex sm:ml-3 space-x-6 lg:space-x-8">
                    <div class="flex sm:flex-col space-x-6 lg:space-y-8 sm:space-x-0 sm:space-y-6">
                    ...
                    <div class="flex sm:flex-col space-x-6 sm:-mt-20 lg:space-y-8 sm:space-x-0 sm:space-y-6">
                      <div class="flex-shrink-0">
                        <img
                          class="h-64 w-64 rounded-lg object-cover md:h-72 md:w-72"
          ...
          <div class="mt-16 md:mt-16 xl:mt-0">
            ...
            <form class="mt-2 flex sm:max-w-md">
              ...
              <input
                ...
                class="min-w-0 w-full appearance-none border border-gray-300 rounded-md bg-white px-4 py-2 text-base text-indigo-500 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 placeholder-gray-500"
              >
