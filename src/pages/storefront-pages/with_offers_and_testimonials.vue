  ...
  <div class="bg-white">
    ...
    <TransitionRoot as="template" :show="mobileMenuOpen">
      <Dialog as="div" class="relative z-40 lg:hidden" @close="mobileMenuOpen = false">
        ...
        <div class="fixed inset-0 z-40 flex">
          ...
          >
            <DialogPanel class="relative max-w-xs w-full flex flex-col overflow-y-auto bg-white pb-12 shadow-xl">
              <div class="flex px-4 pb-2 pt-5">
                <button
                  type="button" class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 -m-2"
              ...
              <TabGroup as="div" class="mt-2">
                <div class="border-b border-gray-200">
                  <TabList class="flex px-4 -mb-px space-x-8">
                    <Tab
                      v-for="category in navigation.categories" :key="category.name" v-slot="{ selected }"
                      as="template"
                    >
                      <button
                        class="flex-1 whitespace-nowrap border-b-2 px-1 py-4 text-base font-medium" :class="[selected ? 'text-indigo-600 border-indigo-600' : 'text-gray-900 border-transparent']"
                      >
                        {{ category.name }}
                      </button>
                    </Tab>
                ...
                <TabPanels as="template">
                  <TabPanel
                    v-for="(category, categoryIdx) in navigation.categories" :key="category.name"
                    class="px-4 pb-6 pt-10 space-y-12"
                  >
                    <div class="grid grid-cols-1 items-start gap-x-6 gap-y-10">
                      <div class="grid grid-cols-1 gap-x-6 gap-y-10">
                        <div>
                          <p :id="`mobile-featured-heading-${categoryIdx}`" class="font-medium text-gray-900">
                            Featured
                          </p>
                          <ul
                            role="list" :aria-labelledby="`mobile-featured-heading-${categoryIdx}`"
              ...
              <div class="border-t border-gray-200 px-4 py-6 space-y-6">
                <div v-for="page in navigation.pages" :key="page.name" class="flow-root">
                  <a :href="page.href" class="block p-2 font-medium text-gray-900 -m-2">{{ page.name }}</a>
                </div>
              </div>

              <div class="border-t border-gray-200 px-4 py-6 space-y-6">
                <div class="flow-root">
                  <a href="#" class="block p-2 font-medium text-gray-900 -m-2">Create an account</a>
                </div>
                <div class="flow-root">
                  <a href="#" class="block p-2 font-medium text-gray-900 -m-2">Sign in</a>
                </div>
              </div>
              ...
              <div class="border-t border-gray-200 px-4 py-6 space-y-6">
                ...
                <form>
                  <div class="inline-block">
                    ...
                    <div
                      class="group relative border-transparent rounded-md -ml-2 focus-within:ring-2 focus-within:ring-white"
                    >
                      <select
                        id="mobile-currency" name="currency"
                        class="flex items-center border-transparent rounded-md bg-none py-0.5 pl-2 pr-5 text-sm font-medium text-gray-700 focus:border-transparent group-hover:text-gray-800 focus:outline-none focus:ring-0"
                      >
    ...
    <header class="relative z-10">
      <nav aria-label="Top">
        ...
        <div class="bg-gray-900">
          <div class="mx-auto h-10 max-w-7xl flex items-center justify-between px-4 lg:px-8 sm:px-6">
            <!-- Currency selector -->
            <form class="hidden lg:block lg:flex-1">
              <div class="flex">
                <label for="desktop-currency" class="sr-only">Currency</label>
                <div
                  class="group relative border-transparent rounded-md bg-gray-900 -ml-2 focus-within:ring-2 focus-within:ring-white"
                >
                  <select
                    id="desktop-currency" name="currency"
                    class="flex items-center border-transparent rounded-md bg-gray-900 bg-none py-0.5 pl-2 pr-5 text-sm font-medium text-white focus:border-transparent group-hover:text-gray-100 focus:outline-none focus:ring-0"
                  >
                    <option v-for="currency in currencies" :key="currency">
                      {{ currency }}
                    </option>
              ...
              <div class="h-16 flex items-center justify-between">
                ...
                <div class="hidden lg:flex lg:items-center">
                  <a href="#">
                    ...
                    <img
                      class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600"
                      alt=""
                    >
                  </a>
                </div>
                ...
                <div class="hidden h-full lg:flex">
                  ...
                  <PopoverGroup class="ml-8">
                    <div class="h-full flex justify-center space-x-8">
                      <Popover
                        v-for="(category, categoryIdx) in navigation.categories" :key="category.name" v-slot="{ open }"
                        class="flex"
                      >
                        <div class="relative flex">
                          <PopoverButton
                            class="relative z-10 flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out -mb-px" :class="[open ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-700 hover:text-gray-800']"
                          >
                            {{ category.name }}
                          </PopoverButton>
                        </div>
                                ...
                                <div class="grid grid-cols-2 items-start gap-x-8 gap-y-10 pb-12 pt-10">
                                  <div class="grid grid-cols-2 gap-x-8 gap-y-10">
                                    <div>
                                      ...
                                      <ul
                                        role="list" :aria-labelledby="`desktop-featured-heading-${categoryIdx}`"
                                    ...
                                    <div>
                                      ...
                                      <ul
                                        role="list" aria-labelledby="desktop-categories-heading"
                                        class="mt-6 sm:mt-4 space-y-6 sm:space-y-4"
                                      >
                                        <li v-for="item in category.categories" :key="item.name" class="flex">
                                          <a :href="item.href" class="hover:text-gray-800">{{ item.name }}</a>
                                  ...
                                  <div class="grid grid-cols-2 gap-x-8 gap-y-10">
                                    <div>
                                      ...
                                      <ul
                                        role="list" aria-labelledby="desktop-collection-heading"
                                        class="mt-6 sm:mt-4 space-y-6 sm:space-y-4"
                                      >
                                        <li v-for="item in category.collection" :key="item.name" class="flex">
                                          <a :href="item.href" class="hover:text-gray-800">{{ item.name }}</a>
                                    ...
                                    <div>
                                      ...
                                      <ul
                                        role="list" aria-labelledby="desktop-brand-heading"
                                        class="mt-6 sm:mt-4 space-y-6 sm:space-y-4"
                                      >
                                        <li v-for="item in category.brands" :key="item.name" class="flex">
                                          <a :href="item.href" class="hover:text-gray-800">{{ item.name }}</a>
                      ...
                      <a
                        v-for="page in navigation.pages" :key="page.name" :href="page.href"
                ...
                <div class="flex flex-1 items-center lg:hidden">
                  <button
                    type="button" class="rounded-md bg-white p-2 text-gray-400 -ml-2"
                  ...
                  <div class="flex items-center lg:ml-8">
                    <div class="flex space-x-8">
                      <div class="hidden lg:flex">
                        <a href="#" class="p-2 text-gray-400 -m-2 hover:text-gray-500">
                          <span class="sr-only">Search</span>
                          <MagnifyingGlassIcon class="h-6 w-6" aria-hidden="true" />
                        </a>
                      </div>
    ...
    <main>
      ...
      <div class="flex flex-col border-b border-gray-200 lg:border-0">
        <nav aria-label="Offers" class="order-last lg:order-first">
          <div class="mx-auto max-w-7xl lg:px-8">
            <ul role="list" class="grid grid-cols-1 lg:grid-cols-3 divide-y divide-gray-200 lg:divide-x lg:divide-y-0">
        ...
        <div class="relative">
          ...
          <div class="relative bg-gray-100 lg:bg-transparent">
            <div class="mx-auto max-w-7xl px-4 lg:grid lg:grid-cols-2 lg:px-8 sm:px-6">
              <div class="mx-auto max-w-2xl py-24 lg:max-w-none lg:py-64">
                <div class="lg:pr-16">
                  ...
                  <div class="mt-6">
                    <a
                      href="#"
                      class="inline-block border border-transparent rounded-md bg-indigo-600 px-8 py-3 font-medium text-white hover:bg-indigo-700"
                    >Shop
                      Productivity</a>
                  </div>
                </div>
          ...
          <div class="h-48 w-full lg:absolute lg:right-0 lg:top-0 lg:h-full lg:w-1/2 sm:h-64">
            <img
              src="https://tailwindui.com/img/ecommerce-images/home-page-02-hero-half-width.jpg" alt=""
      ...
      <section aria-labelledby="trending-heading" class="bg-white">
        <div class="py-16 lg:mx-auto lg:max-w-7xl lg:px-8 lg:py-32 sm:py-24">
          <div class="flex items-center justify-between px-4 lg:px-0 sm:px-6">
            <h2 id="trending-heading" class="text-2xl font-bold tracking-tight text-gray-900">
              Trending products
            </h2>
            <a href="#" class="hidden text-sm font-semibold text-indigo-600 sm:block hover:text-indigo-500">
              See everything
          ...
          <div class="relative mt-8">
            <div class="relative w-full overflow-x-auto">
              <ul
                role="list"
                class="mx-4 inline-flex lg:grid lg:grid-cols-4 lg:mx-0 sm:mx-6 lg:gap-x-8 space-x-8 lg:space-x-0"
              >
                <li
                  v-for="product in trendingProducts" :key="product.id"
                ...
                >
                  ...
                  <ul role="list" class="mt-auto flex items-center justify-center pt-6 space-x-3">
                    <li
                      v-for="color in product.availableColors" :key="color.name"
                      class="h-4 w-4 border border-black border-opacity-10 rounded-full"
      ...
      <section aria-labelledby="collections-heading" class="bg-gray-100">
        <div class="mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
          <div class="mx-auto max-w-2xl py-16 lg:max-w-none lg:py-32 sm:py-24">
            ...
            <div class="mt-6 lg:grid lg:grid-cols-3 lg:gap-x-6 space-y-12 lg:space-y-0">
              <div v-for="collection in collections" :key="collection.name" class="group relative">
                <div
                  class="sm:aspect-w-2 sm:aspect-h-1 lg:aspect-w-1 lg:aspect-h-1 relative h-80 w-full overflow-hidden rounded-lg bg-white sm:h-64 group-hover:opacity-75"
                >
                  <img
      ...
      <div class="relative overflow-hidden">
        ...
        <div aria-hidden="true" class="absolute inset-0">
          <div class="absolute inset-0 mx-auto max-w-7xl overflow-hidden xl:px-8">
            <img
              src="https://tailwindui.com/img/ecommerce-images/home-page-02-sale-full-width.jpg" alt=""
              class="h-full w-full object-cover object-center"
            >
          </div>
          <div class="absolute inset-0 bg-white bg-opacity-75" />
          <div class="absolute inset-0 from-white via-white bg-gradient-to-t" />
        </div>

        <!-- Sale -->
        <section
          aria-labelledby="sale-heading"
          class="relative mx-auto max-w-7xl flex flex-col items-center px-4 pt-32 text-center lg:px-8 sm:px-6"
        >
          <div class="mx-auto max-w-2xl lg:max-w-none">
            <h2 id="sale-heading" class="text-4xl font-bold tracking-tight text-gray-900 lg:text-6xl sm:text-5xl">
              Get 25%
              off during our one-time sale
            </h2>
            ...
            <a
              href="#"
              class="mt-6 inline-block w-full border border-transparent rounded-md bg-gray-900 px-8 py-3 font-medium text-white sm:w-auto hover:bg-gray-800"
            >Get
        ...
        <section
          ...
          class="relative mx-auto max-w-7xl px-4 py-24 lg:px-8 lg:py-32 sm:px-6"
        >
          <div class="mx-auto max-w-2xl lg:max-w-none">
            ...
            <div class="mt-16 lg:grid lg:grid-cols-3 lg:gap-x-8 space-y-16 lg:space-y-0">
              <blockquote v-for="testimonial in testimonials" :key="testimonial.id" class="lg:block sm:flex">
                <svg
                  width="24" height="18" viewBox="0 0 24 18" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                ...
                <div class="mt-8 lg:ml-0 lg:mt-10 sm:ml-6 sm:mt-0">
      ...
      <div class="mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
        <div class="border-t border-gray-200">
          <div class="pb-20 pt-16">
            ...
            <div class="mx-auto mt-16 max-w-5xl xl:grid xl:grid-cols-2 xl:gap-8">
              <div class="grid grid-cols-2 gap-8 xl:col-span-2">
                <div class="md:grid md:grid-cols-2 md:gap-8 space-y-12 md:space-y-0">
                  <div>
          ...
          <div class="lg:grid lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8">
              ...
              <div class="mx-auto max-w-sm">
                ...
                <form class="mt-4 sm:mt-6 sm:flex">
                  ...
                  <input
                    ...
                    class="min-w-0 w-full appearance-none border border-gray-300 rounded-md bg-white px-4 py-2 text-base text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 placeholder-gray-500"
                  >
                  <div class="mt-3 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                    <button
                      type="submit"
                      class="w-full flex items-center justify-center border border-transparent rounded-md bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:ring-offset-white"
                    >
                      Sign
                      up
                    </button>
            ...
            <div class="relative mt-6 flex items-center px-6 py-12 lg:mt-0 sm:px-10 sm:py-16">
              <div class="absolute inset-0 overflow-hidden rounded-lg">
                <img
                  src="https://tailwindui.com/img/ecommerce-images/footer-02-exclusive-sale.jpg" alt=""
              ...
              <div class="relative mx-auto max-w-sm text-center">
                ...
                <p class="mt-2 text-gray-200">
                  Did you sign up to the newsletter? If so, use the keyword we sent you to get access. <a
                    href="#"
                    class="whitespace-nowrap font-bold text-white hover:text-gray-200"
                  >Go now<span aria-hidden="true">
                    &rarr;</span></a>
                </p>
              </div>
            </div>
        ...
        <div class="py-10 md:flex md:items-center md:justify-between">
          ...
          <div class="mt-4 flex items-center justify-center md:mt-0">
            <div class="flex space-x-8">
              <a
                v-for="item in footerNavigation.bottomLinks" :key="item.name" :href="item.href"
