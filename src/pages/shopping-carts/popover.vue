      ...
      <div class="relative border-b border-gray-200 px-4 pb-14 sm:static sm:px-0 sm:pb-0">
        <div class="h-16 flex items-center justify-between">
          ...
          <div class="absolute inset-x-0 bottom-0 overflow-x-auto border-t sm:static sm:border-t-0">
            <div class="h-14 flex items-center px-4 sm:h-auto space-x-8">
              <a
          ...
          <div class="flex flex-1 items-center justify-end">
            ...
            <Popover class="ml-4 flow-root text-sm lg:relative lg:ml-8">
              <PopoverButton class="group flex items-center p-2 -m-2">
                <ShoppingBagIcon
              ...
              >
                <PopoverPanel
                  class="absolute inset-x-0 top-16 mt-px bg-white pb-6 shadow-lg lg:left-auto lg:right-0 lg:top-full lg:mt-3 lg:w-80 lg:rounded-lg sm:px-2 lg:ring-1 lg:ring-black lg:ring-opacity-5 lg:-mr-1.5"
                >
                  <h2 class="sr-only">
                    Shopping Cart
                  </h2>
                  ...
                  <form class="mx-auto max-w-2xl px-4">
                    <ul role="list" class="divide-y divide-gray-200">
                      <li v-for="product in products" :key="product.id" class="flex items-center py-6">
                        <img
                          ...
                          class="h-16 w-16 flex-none border border-gray-200 rounded-md"
                        >
                    ...
                    <button
                      type="submit"
                      class="w-full border border-transparent rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:ring-offset-gray-50"
                    >
                      Checkout
                    </button>
