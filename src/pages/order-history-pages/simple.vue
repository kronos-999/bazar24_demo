...
<template>
  <div class="bg-white">
    ...
    <main class="mx-auto max-w-2xl px-4 py-24 lg:max-w-7xl lg:px-8 sm:px-6" aria-labelledby="order-history-heading">
      <div class="max-w-xl">
      ...
      <div
        class="grid grid-cols-1 mt-16 gap-x-6 gap-y-10 lg:grid-cols-3 sm:grid-cols-2 xl:grid-cols-4 lg:gap-x-8 sm:gap-y-16"
      >
        <div v-for="order in orders" :key="order.id" class="group relative">
          ...
          <p class="mt-1 text-lg font-medium">
            <span v-if="order.status === 'delivered'" class="text-gray-900">Delivered on <time
