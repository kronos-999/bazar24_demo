...
<template>
  <div class="bg-gray-50">
    <header class="relative bg-white shadow-sm">
      <nav aria-label="Top" class="mx-auto max-w-7xl lg:px-8 sm:px-6">
        <div class="px-4 pb-14 sm:px-0 sm:pb-0">
          <div class="h-16 flex items-center justify-between">
            ...
            <PopoverGroup class="absolute inset-x-0 bottom-0 sm:static sm:flex-1 sm:self-stretch">
              <div
                class="h-14 flex overflow-x-auto border-t px-4 pb-px sm:h-full sm:justify-center space-x-8 sm:overflow-visible sm:border-t-0 sm:pb-0"
              >
                <Popover
                  v-for="(category, categoryIdx) in navigation.categories" :key="categoryIdx" v-slot="{ open }"
                  class="flex"
                >
                  ...
                  >
                    <PopoverPanel class="absolute inset-x-0 top-full z-20 bg-white text-gray-500 sm:text-sm">
                      ...
                      <div
                        class="absolute inset-0 mx-auto h-px max-w-7xl -top-px sm:top-0 lg:px-8 sm:px-6"
                        aria-hidden="true"
                      >
                        <div
                          ...
                          >
                            <div class="grid grid-cols-1 gap-x-6 gap-y-10 lg:gap-x-8">
                              <div>
                                ...
                                <div class="mt-4 border-t border-gray-200 pt-6 sm:grid sm:grid-cols-2 sm:gap-x-6">
                                  ...
                                  <ul role="list" aria-label="More clothing" class="mt-6 sm:mt-0 space-y-6 sm:space-y-4">
                            ...
                            <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:gap-x-8">
                              <div>
                                ...
                                <ul
                                  role="list" aria-labelledby="accessories-heading"
                              ...
                              <div>
                                ...
                                <ul
                                  role="list" aria-labelledby="categories-heading"
                                  class="mt-4 border-t border-gray-200 pt-6 space-y-6 sm:space-y-4"
                                >
                ...
                <a
                  v-for="item in navigation.other" :key="item.name" :href="item.href"
    ...
    <main class="py-24">
      <div class="mx-auto max-w-7xl lg:px-8 sm:px-2">
      ...
      <section aria-labelledby="recent-heading" class="mt-16">
        ...
        <div class="mx-auto max-w-7xl lg:px-8 sm:px-2">
          <div class="mx-auto max-w-2xl lg:max-w-4xl space-y-8 lg:px-0 sm:px-4">
            <div
              v-for="order in orders" :key="order.number"
            ...
            >
              ...
              <div class="flex items-center border-b border-gray-200 p-4 sm:grid sm:grid-cols-4 sm:gap-x-6 sm:p-6">
                <dl class="grid grid-cols-2 flex-1 gap-x-6 text-sm lg:col-span-2 sm:col-span-3 sm:grid-cols-3">
                  <div>
                ...
                <Menu as="div" class="relative flex justify-end lg:hidden">
                  <div class="flex items-center">
                    <MenuButton class="flex items-center p-2 text-gray-400 -m-2 hover:text-gray-500">
                ...
                <div class="hidden lg:col-span-2 lg:flex lg:items-center lg:justify-end lg:space-x-4">
                  <a
                    :href="order.href"
                    class="flex items-center justify-center border border-gray-300 rounded-md bg-white px-2.5 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >
              ...
              <ul role="list" class="divide-y divide-gray-200">
                <li v-for="product in order.products" :key="product.id" class="p-4 sm:p-6">
                  ...
                  <div class="mt-6 sm:flex sm:justify-between">
                    ...
                    <div
                      class="mt-6 flex items-center border-t border-gray-200 pt-4 text-sm font-medium sm:ml-4 sm:mt-0 space-x-4 divide-x divide-gray-200 sm:border-none sm:pt-0"
                    >
                      <div class="flex flex-1 justify-center">
                        <a :href="product.href" class="whitespace-nowrap text-indigo-600 hover:text-indigo-500">View
                          product</a>
                      </div>
