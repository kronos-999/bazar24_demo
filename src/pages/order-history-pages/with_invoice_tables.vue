...
<template>
  <div class="bg-white">
    ...
    <main class="mx-auto max-w-7xl px-4 py-16 lg:px-8 sm:px-6 lg:pb-24">
      <div class="max-w-xl">
      ...
      <section aria-labelledby="recent-heading" class="mt-16">
        ...
        <div class="space-y-20">
          <div v-for="order in orders" :key="order.number">
            ...
            <div
              class="rounded-lg bg-gray-50 px-4 py-6 sm:flex sm:items-center sm:justify-between sm:px-6 lg:space-x-8 sm:space-x-6"
            >
              <dl
                class="flex-auto text-sm text-gray-600 sm:grid sm:grid-cols-3 lg:w-1/2 lg:flex-none lg:gap-x-8 sm:gap-x-6 space-y-6 divide-y divide-gray-200 sm:space-y-0 sm:divide-y-0"
              >
              ...
              <a
                ...
                class="mt-6 w-full flex items-center justify-center border border-gray-300 rounded-md bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm sm:mt-0 sm:w-auto hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                View Invoice
            ...
            <table class="mt-4 w-full text-gray-500 sm:mt-6">
              ...
              <thead class="sr-only text-left text-sm text-gray-500 sm:not-sr-only">
                <tr>
                  <th scope="col" class="py-3 pr-8 font-normal lg:w-1/3 sm:w-2/5">
                    Product
                  </th>
              ...
              <tbody class="border-b border-gray-200 text-sm divide-y divide-gray-200 sm:border-t">
                <tr v-for="product in order.products" :key="product.id">
                  ...
                  <td class="whitespace-nowrap py-6 text-right font-medium">
                    <a :href="product.href" class="text-indigo-600">View<span class="hidden lg:inline">Product</span><span
                      class="sr-only"
                    >, {{ product.name }}</span></a>
                  </td>
                </tr>
