...
<template>
  <div class="bg-gray-50">
    ...
    <div class="mx-auto max-w-3xl px-4 text-center lg:max-w-7xl lg:px-8 sm:px-6">
      <div class="py-24">
        <h1 class="text-4xl font-bold tracking-tight text-gray-900">
          New Arrivals
        </h1>
        <p class="mx-auto mt-4 max-w-3xl text-base text-gray-500">
          Thoughtfully designed objects for the workspace, home,
          and travel.
        </p>
      </div>
      ...
      <section aria-labelledby="filter-heading" class="border-t border-gray-200 py-6">
        ...
        <div class="flex items-center justify-between">
          ...
          <PopoverGroup class="hidden sm:flex sm:items-baseline sm:space-x-8">
            <Popover
              v-for="(section, sectionIdx) in filters" :id="`desktop-menu-${sectionIdx}`" :key="section.name"
