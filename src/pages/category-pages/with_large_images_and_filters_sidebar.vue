...
<template>
  <div class="bg-white">
    ...
    <div>
            ...
            >
              ...
              >
                ...
                <form class="mt-4 border-t border-gray-200">
                  ...
                  <Disclosure
                    v-for="section in filters" :key="section.id" v-slot="{ open }"
                    as="div" class="border-t border-gray-200 px-4 py-6"
                  >
                    <h3 class="flow-root -mx-2 -my-3">
                      <DisclosureButton
                        class="w-full flex items-center justify-between bg-white px-2 py-3 text-gray-400 hover:text-gray-500"
                      >
      ...
      <main class="mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
        <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
          ...
          <div class="flex items-center">
            ...
            <button type="button" class="ml-5 p-2 text-gray-400 -m-2 sm:ml-7 hover:text-gray-500">
              <span class="sr-only">View grid</span>
              <Squares2X2Icon class="h-5 w-5" aria-hidden="true" />
            </button>
            <button
              type="button" class="ml-4 p-2 text-gray-400 -m-2 sm:ml-6 lg:hidden hover:text-gray-500"
        ...
        <section aria-labelledby="products-heading" class="pb-24 pt-6">
          ...
          <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
            ...
            <form class="hidden lg:block">
              ...
              <ul role="list" class="border-b border-gray-200 pb-6 text-sm font-medium text-gray-900 space-y-4">
                <li v-for="category in subCategories" :key="category.name">
              ...
              <Disclosure
                v-for="section in filters" :key="section.id" v-slot="{ open }" as="div"
                class="border-b border-gray-200 py-6"
              >
                <h3 class="flow-root -my-3">
                  <DisclosureButton
                    class="w-full flex items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500"
                  >
                    <span class="font-medium text-gray-900">{{ section.name }}</span>
                    <span class="ml-6 flex items-center">
                      <PlusIcon v-if="!open" class="h-5 w-5" aria-hidden="true" />
            ...
            <!-- Product grid -->
            <div class="grid grid-cols-1 gap-x-6 gap-y-10 lg:col-span-3 sm:grid-cols-2 lg:gap-x-8">
