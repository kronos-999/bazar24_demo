...
<template>
  <div class="bg-white">
          ...
          <TransitionChild as="template" enter="transition ease-in-out duration-300 transform" enter-from="-translate-x-full" enter-to="translate-x-0" leave="transition ease-in-out duration-300 transform" leave-from="translate-x-0" leave-to="-translate-x-full">
            <DialogPanel class="relative max-w-xs w-full flex flex-col overflow-y-auto bg-white pb-12 shadow-xl">
              <div class="flex px-4 pb-2 pt-5">
                <button type="button" class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 -m-2" @click="open = false">
              ...
              <TabGroup as="div" class="mt-2">
                <div class="border-b border-gray-200">
                  <TabList class="flex px-4 -mb-px space-x-8">
                    <Tab v-for="category in navigation.categories" :key="category.name" v-slot="{ selected }" as="template">
                      <button class="flex-1 whitespace-nowrap border-b-2 px-1 py-4 text-base font-medium" :class="[selected ? 'text-indigo-600 border-indigo-600' : 'text-gray-900 border-transparent']">
                        {{ category.name }}
                      </button>
                    </Tab>
                  </TabList>
                ...
                <TabPanels as="template">
                  <TabPanel v-for="category in navigation.categories" :key="category.name" class="px-4 pb-8 pt-10 space-y-10">
                    <div class="space-y-4">
                      ...
                      <div v-for="section in column" :key="section.name">
                        ...
                        <ul role="list" :aria-labelledby="`${category.id}-${section.id}-heading-mobile`" class="mt-6 flex flex-col space-y-6">
                          <li v-for="item in section.items" :key="item.name" class="flow-root">
                            <a :href="item.href" class="block p-2 text-gray-500 -m-2">{{ item.name }}</a>
                          </li>
                        </ul>
                      </div>
                    </div>
    ...
    <header class="relative bg-white">
      <nav aria-label="Top" class="mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
        <div class="border-b border-gray-200">
          <div class="h-16 flex items-center justify-between">
            <div class="flex flex-1 items-center lg:hidden">
              <button type="button" class="rounded-md bg-white p-2 text-gray-400 -ml-2" @click="open = true">
                        ...
                        <div class="mx-auto max-w-7xl px-8">
                          <div class="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                            <div class="grid grid-cols-2 grid-rows-1 gap-8 text-sm">
                              <div v-for="(item, itemIdx) in category.featured" :key="item.name" class="group aspect-w-1 aspect-h-1 relative overflow-hidden rounded-md bg-gray-100" :class="[itemIdx === 0 ? 'col-span-2 aspect-w-2' : '']">
                                <img :src="item.imageSrc" :alt="item.imageAlt" class="object-cover object-center group-hover:opacity-75">
                                <div class="flex flex-col justify-end">
            ...
            <div class="flex flex-1 items-center justify-end">
              <a href="#" class="hidden text-gray-700 lg:flex lg:items-center hover:text-gray-800">
                <img src="https://tailwindui.com/img/flags/flag-canada.svg" alt="" class="block h-auto w-5 flex-shrink-0">
              ...
              <!-- Search -->
              <a href="#" class="ml-6 hidden p-2 text-gray-400 lg:block hover:text-gray-500">
                <span class="sr-only">Search</span>
                <MagnifyingGlassIcon class="h-6 w-6" aria-hidden="true" />
              </a>

              <!-- Account -->
              <a href="#" class="p-2 text-gray-400 lg:ml-4 hover:text-gray-500">
    ...
    <main class="pb-24">
      <div class="px-4 py-16 text-center lg:px-8 sm:px-6">
      ...
      <Disclosure as="section" aria-labelledby="filter-heading" class="grid items-center border-b border-t border-gray-200">
        ...
        <div class="relative col-start-1 row-start-1 py-4">
          <div class="mx-auto max-w-7xl flex px-4 text-sm space-x-6 divide-x divide-gray-200 lg:px-8 sm:px-6">
            <div>
        ...
        <DisclosurePanel class="border-t border-gray-200 py-10">
          <div class="grid grid-cols-2 mx-auto max-w-7xl gap-x-4 px-4 text-sm md:gap-x-6 lg:px-8 sm:px-6">
              ...
              <fieldset>
                ...
                <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
                  <div v-for="(option, optionIdx) in filters.price" :key="option.value" class="flex items-center text-base sm:text-sm">
                    <input :id="`price-${optionIdx}`" name="price[]" :value="option.value" type="checkbox" class="h-4 w-4 flex-shrink-0 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500" :checked="option.checked">
              ...
              <fieldset>
                ...
                <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
                  <div v-for="(option, optionIdx) in filters.color" :key="option.value" class="flex items-center text-base sm:text-sm">
                    <input :id="`color-${optionIdx}`" name="color[]" :value="option.value" type="checkbox" class="h-4 w-4 flex-shrink-0 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500" :checked="option.checked">
              ...
              <fieldset>
                ...
                <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
                  <div v-for="(option, optionIdx) in filters.size" :key="option.value" class="flex items-center text-base sm:text-sm">
                    <input :id="`size-${optionIdx}`" name="size[]" :value="option.value" type="checkbox" class="h-4 w-4 flex-shrink-0 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500" :checked="option.checked">
              ...
              <fieldset>
                ...
                <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
                  <div v-for="(option, optionIdx) in filters.category" :key="option.value" class="flex items-center text-base sm:text-sm">
                    <input :id="`category-${optionIdx}`" name="category[]" :value="option.value" type="checkbox" class="h-4 w-4 flex-shrink-0 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500" :checked="option.checked">
        ...
        <div class="col-start-1 row-start-1 py-4">
          <div class="mx-auto max-w-7xl flex justify-end px-4 lg:px-8 sm:px-6">
            <Menu as="div" class="relative inline-block">
              <div class="flex">
                <MenuButton class="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900">
                  Sort
                  <ChevronDownIcon class="ml-1 h-5 w-5 flex-shrink-0 text-gray-400 -mr-1 group-hover:text-gray-500" aria-hidden="true" />
                </MenuButton>
              </div>
      ...
      <!-- Product grid -->
      <section aria-labelledby="products-heading" class="mx-auto max-w-7xl overflow-hidden lg:px-8 sm:px-6">
        <h2 id="products-heading" class="sr-only">
          Products
        </h2>

        <div class="grid grid-cols-2 border-l border-gray-200 lg:grid-cols-4 md:grid-cols-3 -mx-px sm:mx-0">
      ...
      <!-- Pagination -->
      <nav aria-label="Pagination" class="mx-auto mt-6 max-w-7xl flex justify-between px-4 text-sm font-medium text-gray-700 lg:px-8 sm:px-6">
        <div class="min-w-0 flex-1">
          <a href="#" class="h-10 inline-flex items-center border border-gray-300 rounded-md bg-white px-4 focus:border-indigo-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-indigo-600 focus:ring-opacity-25 focus:ring-offset-indigo-600">Previous</a>
        </div>
        <div class="hidden sm:flex space-x-2">
          <!-- Current: "border-indigo-600 ring-1 ring-indigo-600", Default: "border-gray-300" -->
          <a href="#" class="h-10 inline-flex items-center border border-gray-300 rounded-md bg-white px-4 focus:border-indigo-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-indigo-600 focus:ring-opacity-25 focus:ring-offset-indigo-600">1</a>
          <a href="#" class="h-10 inline-flex items-center border border-gray-300 rounded-md bg-white px-4 focus:border-indigo-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-indigo-600 focus:ring-opacity-25 focus:ring-offset-indigo-600">2</a>
          <a href="#" class="h-10 inline-flex items-center border border-indigo-600 rounded-md bg-white px-4 ring-1 ring-indigo-600 focus:border-indigo-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-indigo-600 focus:ring-opacity-25 focus:ring-offset-indigo-600">3</a>
          <span class="h-10 inline-flex items-center px-1.5 text-gray-500">...</span>
          <a href="#" class="h-10 inline-flex items-center border border-gray-300 rounded-md bg-white px-4 focus:border-indigo-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-indigo-600 focus:ring-opacity-25 focus:ring-offset-indigo-600">8</a>
          <a href="#" class="h-10 inline-flex items-center border border-gray-300 rounded-md bg-white px-4 focus:border-indigo-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-indigo-600 focus:ring-opacity-25 focus:ring-offset-indigo-600">9</a>
          <a href="#" class="h-10 inline-flex items-center border border-gray-300 rounded-md bg-white px-4 focus:border-indigo-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-indigo-600 focus:ring-opacity-25 focus:ring-offset-indigo-600">10</a>
        </div>
        <div class="min-w-0 flex flex-1 justify-end">
          <a href="#" class="h-10 inline-flex items-center border border-gray-300 rounded-md bg-white px-4 focus:border-indigo-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-indigo-600 focus:ring-opacity-25 focus:ring-offset-indigo-600">Next</a>
        </div>
      </nav>
    </main>
    ...
    <footer aria-labelledby="footer-heading" class="bg-white">
      ...
      <div class="mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
        <div class="grid grid-cols-2 gap-8 border-t border-gray-200 py-20 lg:grid-cols-4 sm:grid-cols-2 sm:gap-y-0">
