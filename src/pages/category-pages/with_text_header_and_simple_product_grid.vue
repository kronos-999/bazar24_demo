      ...
      <TransitionRoot as="template" :show="mobileFiltersOpen">
        <Dialog as="div" class="relative z-40 sm:hidden" @close="mobileFiltersOpen = false">
          ...
          <div class="fixed inset-0 z-40 flex">
            ...
            >
              <DialogPanel
                class="relative ml-auto h-full max-w-xs w-full flex flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl"
              >
      ...
      <main>
        <div class="bg-white">
          <div class="mx-auto max-w-7xl px-4 py-16 lg:px-8 sm:px-6">
            ...
            <p class="mt-4 max-w-xl text-sm text-gray-700">
              ...
              limited runs. Improve your productivity and organization with these sale items before we run out.
            </p>
          </div>
        </div>
        ...
        <section aria-labelledby="filter-heading">
                  ...
                  >
                    <div class="py-1">
                      <MenuItem v-for="option in sortOptions" :key="option.name" v-slot="{ active }">
                        <a
                          :href="option.href"
                          class="block px-4 py-2 text-sm" :class="[option.current ? 'font-medium text-gray-900' : 'text-gray-500', active ? 'bg-gray-100' : '']"
                        >{{ option.name }}</a>
                      </MenuItem>
                    </div>
                  </MenuItems>
          ...
          <div class="bg-gray-100">
            <div class="mx-auto max-w-7xl px-4 py-3 sm:flex sm:items-center lg:px-8 sm:px-6">
              ...
              <div class="mt-2 sm:ml-4 sm:mt-0">
                <div class="flex flex-wrap items-center -m-1">
                  <span
                    ...
                    class="m-1 inline-flex items-center border border-gray-200 rounded-full bg-white py-1.5 pl-3 pr-2 text-sm font-medium text-gray-900"
                  >
                    <span>{{ activeFilter.label }}</span>
                    <button
                      type="button"
                      class="ml-1 h-4 w-4 inline-flex flex-shrink-0 rounded-full p-1 text-gray-400 hover:bg-gray-200 hover:text-gray-500"
                    >
        ...
        <section
          ...
          class="mx-auto max-w-2xl px-4 pb-16 pt-12 lg:max-w-7xl lg:px-8 sm:px-6 sm:pb-24 sm:pt-16"
        >
          <h2 id="products-heading" class="sr-only">
            Products
          </h2>

          <div class="grid grid-cols-1 gap-x-6 gap-y-10 lg:grid-cols-3 sm:grid-cols-2 xl:grid-cols-4 xl:gap-x-8">
            <a v-for="product in products" :key="product.id" :href="product.href" class="group">
              <div
                class="aspect-w-1 aspect-h-1 xl:aspect-w-7 xl:aspect-h-8 w-full overflow-hidden rounded-lg bg-gray-200"
              >
                <img
