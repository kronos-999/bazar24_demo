  ...
  <div class="bg-white">
    <div>
      ...
      <header class="relative bg-white">
        <p
          class="h-10 flex items-center justify-center bg-indigo-600 px-4 text-sm font-medium text-white lg:px-8 sm:px-6"
        >
        ...
        <nav aria-label="Top" class="mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
          <div class="border-b border-gray-200">
            <div class="h-16 flex items-center">
              <button
                type="button" class="rounded-md bg-white p-2 text-gray-400 lg:hidden"
          ...
          <ol role="list" class="flex items-center py-4 space-x-4">
            <li v-for="breadcrumb in breadcrumbs" :key="breadcrumb.id">
              <div class="flex items-center">
                ...
                <svg
                  viewBox="0 0 6 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
          ...
          <section aria-labelledby="product-heading" class="mt-6 lg:col-span-2 xl:col-span-3 lg:mt-0">
            ...
            <div class="grid grid-cols-1 gap-y-4 sm:grid-cols-2 xl:grid-cols-3 lg:gap-x-8 sm:gap-x-6 sm:gap-y-10">
              <div
                ...
                class="group relative flex flex-col overflow-hidden border border-gray-200 rounded-lg bg-white"
              >
