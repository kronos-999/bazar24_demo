...
<template>
  <footer class="body-font text-gray-600 dark:bg-gray-900 dark:text-gray-400">
    <div class="mx-auto px-5 py-24 container">
      <div class="order-first flex flex-wrap text-center md:text-left">
        ...
        <div class="w-full px-4 lg:w-1/4 md:w-1/2">
          ...
          <div
            class="flex flex-wrap items-end justify-center lg:flex-wrap md:flex-nowrap xl:flex-nowrap md:justify-start"
          >
            <div class="relative mr-2 w-40 lg:mr-0 sm:mr-4 xl:mr-4 sm:w-auto">
              <label for="footer-field" class="text-sm leading-7 text-gray-600 dark:text-gray-400">Placeholder</label>
              <input
                id="footer-field"
                type="text"
                name="footer-field"
                :class="`w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:bg-transparent focus:ring-2 focus:ring-${theme}-200 focus:border-${theme}-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out dark:bg-gray-800 dark:bg-opacity-40 dark:border-gray-700 dark:focus:ring-${theme}-900 dark:text-gray-100`"
              >
            </div>
            <button
              :class="`lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-${theme}-500 border-0 py-2 px-6 focus:outline-none hover:bg-${theme}-600 rounded`"
            >
              Button
            </button>
          </div>
    ...
    <div class="bg-gray-100 dark:bg-gray-800 dark:bg-opacity-75">
      <div class="mx-auto flex flex-col items-center px-5 py-6 container sm:flex-row">
        <a
        ...
        >
          <svg
            ...
            stroke-width="2"
            :class="`w-10 h-10 text-white p-2 bg-${theme}-500 rounded-full`"
            viewBox="0 0 24 24"
          >
