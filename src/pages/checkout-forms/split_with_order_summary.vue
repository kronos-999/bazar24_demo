  ...
  <div class="bg-white">
    ...
    <div class="relative grid grid-cols-1 mx-auto max-w-7xl gap-x-16 lg:grid-cols-2 lg:px-8 lg:pt-16">
      ...
      <section
        ...
        class="bg-indigo-900 py-12 text-indigo-300 lg:col-start-2 lg:row-start-1 lg:mx-auto lg:max-w-lg lg:w-full lg:bg-transparent lg:px-0 md:px-10 lg:pb-24 lg:pt-0"
      >
