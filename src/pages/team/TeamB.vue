  ...
  <section class="body-font text-gray-600 dark:bg-gray-900 dark:text-gray-400">
    <div class="mx-auto px-5 py-24 container">
      <div class="mb-20 w-full flex flex-col text-center">
        <h1 class="title-font mb-4 text-2xl font-medium tracking-widest text-gray-900 dark:text-white">
          OUR TEAM
        </h1>
      ...
      <div class="flex flex-wrap -m-4">
        <div class="p-4 lg:w-1/2">
          <div
            class="h-full flex flex-col items-center justify-center text-center sm:flex-row sm:justify-start sm:text-left"
          >
            <img
              alt="team" class="mb-4 h-48 w-48 flex-shrink-0 rounded-lg object-cover object-center sm:mb-0"
