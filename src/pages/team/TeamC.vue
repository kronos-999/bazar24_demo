  ...
  <section class="body-font text-gray-600 dark:bg-gray-900 dark:text-gray-400">
    <div class="mx-auto px-5 py-24 container">
      <div class="mb-20 w-full flex flex-col text-center">
        <h1 class="title-font mb-4 text-2xl font-medium text-gray-900 dark:text-white">
          OUR TEAM
        </h1>
      ...
      <div class="flex flex-wrap -m-4">
        <div class="p-4 lg:w-1/4 md:w-1/2">
          <div class="h-full flex flex-col items-center text-center">
            <img
              alt="team" class="mb-4 h-56 w-full flex-shrink-0 rounded-lg object-cover object-center"
            ...
            <div class="w-full">
              ...
              <span class="inline-flex">
                <a class="text-gray-500 dark:text-gray-700">
                  <svg
                ...
                <a class="ml-2 text-gray-500 dark:text-gray-700">
                  <svg
                    fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    class="h-5 w-5" viewBox="0 0 24 24"
                  >
