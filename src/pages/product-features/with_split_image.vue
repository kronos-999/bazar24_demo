...
<template>
  <div class="bg-white">
    <section aria-labelledby="features-heading" class="relative">
      <div
        class="aspect-w-3 aspect-h-2 sm:aspect-w-5 lg:aspect-none overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-16"
      >
        <img
      ...
      <div
        class="mx-auto max-w-2xl px-4 pb-24 pt-16 lg:grid lg:grid-cols-2 lg:max-w-7xl lg:gap-x-8 lg:px-8 sm:px-6 lg:pt-32 sm:pb-32"
      >
        <div class="lg:col-start-2">
          ...
          <dl class="grid grid-cols-1 mt-10 gap-x-8 gap-y-10 text-sm sm:grid-cols-2">
