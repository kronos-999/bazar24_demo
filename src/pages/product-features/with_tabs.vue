...
<template>
  <div class="bg-white">
    <section aria-labelledby="features-heading" class="mx-auto max-w-7xl py-32 lg:px-8 sm:px-2">
      <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
        <div class="max-w-3xl">
          ...
          <p class="mt-4 text-gray-500">
            ...
            most used items. Keep everything at reach and in its place, while dressing up your workspace.
          </p>
        </div>

        <TabGroup as="div" class="mt-4">
          <div class="flex overflow-x-auto -mx-4 sm:mx-0">
            <div class="flex-auto border-b border-gray-200 px-4 sm:px-0">
              <TabList class="flex -mb-px space-x-10">
                <Tab v-for="tab in tabs" :key="tab.name" v-slot="{ selected }" as="template">
                  <button
                    class="whitespace-nowrap border-b-2 py-6 text-sm font-medium" :class="[selected ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300']"
                  >
                    {{ tab.name }}
                  </button>
                </Tab>
          ...
          <TabPanels as="template">
            <TabPanel v-for="tab in tabs" :key="tab.name" class="pt-10 space-y-16 lg:pt-16">
              <div
                v-for="feature in tab.features" :key="feature.name"
              ...
              >
                ...
                <div class="lg:col-span-7">
                  <div class="aspect-w-2 aspect-h-1 sm:aspect-w-5 sm:aspect-h-2 overflow-hidden rounded-lg bg-gray-100">
