      ...
      <div class="mx-auto max-w-2xl px-4 lg:max-w-none">
        <div class="max-w-3xl">
          ...
          <p class="mt-4 text-gray-500">
            The Drawstring Canister comes with multiple strap and handle options to adapt
            throughout your day. Shoulder sling it, backpack it, or handy carry it.
          </p>
        </div>
        ...
        <div class="mt-10 border-t border-gray-200 pt-10 sm:mt-16 space-y-16 sm:pt-16">
          ...
          >
            <div class="mt-6 lg:col-span-5 xl:col-span-4 lg:mt-0">
