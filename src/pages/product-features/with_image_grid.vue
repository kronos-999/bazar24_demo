...
<template>
  <div class="bg-white">
    <div
      class="grid grid-cols-1 mx-auto max-w-2xl items-center gap-x-8 gap-y-16 px-4 py-24 lg:grid-cols-2 lg:max-w-7xl lg:px-8 sm:px-6 sm:py-32"
    >
      <div>
        ...
        <p class="mt-4 text-gray-500">
          ...
          cards. The powder coated steel divider separates active cards from new ones, or can be used to archive important
          task lists.
        </p>

        <dl class="grid grid-cols-1 mt-16 gap-x-6 gap-y-10 sm:grid-cols-2 lg:gap-x-8 sm:gap-y-16">
      ...
      <div class="grid grid-cols-2 grid-rows-2 gap-4 lg:gap-8 sm:gap-6">
        <img
