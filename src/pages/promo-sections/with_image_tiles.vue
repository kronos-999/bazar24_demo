      ...
      <div class="relative mx-auto max-w-7xl px-4 sm:static lg:px-8 sm:px-6">
        ...
        <div>
          <div class="mt-10">
            ...
            <div aria-hidden="true" class="pointer-events-none lg:absolute lg:inset-y-0 lg:mx-auto lg:max-w-7xl lg:w-full">
              <div class="absolute transform lg:left-1/2 lg:top-1/2 sm:left-1/2 sm:top-0 lg:translate-x-8 sm:translate-x-8 lg:-translate-y-1/2">
            ...
            <a href="#" class="inline-block border border-transparent rounded-md bg-indigo-600 px-8 py-3 text-center font-medium text-white hover:bg-indigo-700">Shop Collection</a>
          </div>
        </div>
      </div>
    </div>
