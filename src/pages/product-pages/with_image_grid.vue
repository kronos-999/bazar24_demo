  ...
  <div class="bg-white">
    ...
    <main class="pt-10 sm:pt-16">
      <nav aria-label="Breadcrumb">
        <ol role="list" class="mx-auto max-w-2xl flex items-center px-4 lg:max-w-7xl space-x-2 lg:px-8 sm:px-6">
          <li v-for="breadcrumb in product.breadcrumbs" :key="breadcrumb.id">
            <div class="flex items-center">
              <a :href="breadcrumb.href" class="mr-2 text-sm font-medium text-gray-900">{{ breadcrumb.name }}</a>
              <svg
                width="16" height="20" viewBox="0 0 16 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
          ...
          <li class="text-sm">
            <a
              :href="product.href" aria-current="page"
      ...
      <!-- Image gallery -->
      <div class="mx-auto mt-6 max-w-2xl lg:grid lg:grid-cols-3 lg:max-w-7xl lg:gap-x-8 lg:px-8 sm:px-6">
        ...
        <div class="aspect-w-4 aspect-h-5 lg:aspect-w-3 lg:aspect-h-4 sm:overflow-hidden sm:rounded-lg">
          <img
      ...
      <!-- Product info -->
      <div
        class="mx-auto max-w-2xl px-4 pt-10 lg:grid lg:grid-rows-[auto,auto,1fr] lg:grid-cols-3 lg:max-w-7xl lg:gap-x-8 lg:px-8 sm:px-6 lg:pt-16"
      >
            ...
            <div class="flex items-center">
              <div class="flex items-center">
                <StarIcon
                  ...
                  class="h-5 w-5 flex-shrink-0" :class="[reviews.average > rating ? 'text-gray-900' : 'text-gray-200']"
                  aria-hidden="true"
                />
              </div>
              <p class="sr-only">
          ...
          <form class="mt-10">
            ...
            <div class="mt-10">
              ...
              <RadioGroup v-model="selectedSize" class="mt-4">
                ...
                <div class="grid grid-cols-4 gap-4 lg:grid-cols-4 sm:grid-cols-8">
                  <RadioGroupOption
                    v-for="size in product.sizes" :key="size.name" v-slot="{ active, checked }" as="template"
                    :value="size" :disabled="!size.inStock"
                  >
                    <div
                      class="group relative flex items-center justify-center border rounded-md px-4 py-3 text-sm font-medium uppercase sm:flex-1 hover:bg-gray-50 sm:py-6 focus:outline-none" :class="[size.inStock ? 'bg-white shadow-sm text-gray-900 cursor-pointer' : 'bg-gray-50 text-gray-200 cursor-not-allowed', active ? 'ring-2 ring-indigo-500' : '']"
                    >
                      ...
                      >
                        <svg
                          class="absolute inset-0 h-full w-full stroke-2 text-gray-200" viewBox="0 0 100 100"
            ...
            <button
              type="submit"
              class="mt-10 w-full flex items-center justify-center border border-transparent rounded-md bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Add
              to bag
            </button>
        ...
        <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
          ...
          <div class="mt-10">
            ...
            <div class="mt-4">
              <ul role="list" class="list-disc pl-4 text-sm space-y-2">
            ...
            <div class="space-y-10">
              <div v-for="review in reviews.featured" :key="review.id" class="flex flex-col sm:flex-row">
                <div class="order-2 mt-6 sm:ml-16 sm:mt-0">
                  ...
                  <div class="mt-3 text-sm text-gray-600 space-y-6" v-html="review.content" />
                </div>
                ...
                <div class="order-1 flex items-center sm:flex-col sm:items-start">
                  ...
                  <div class="ml-4 sm:ml-0 sm:mt-4">
                    ...
                    <div class="mt-2 flex items-center">
                      <StarIcon
                        v-for="rating in [0, 1, 2, 3, 4]" :key="rating"
                        class="h-5 w-5 flex-shrink-0" :class="[review.rating > rating ? 'text-gray-900' : 'text-gray-200']"
                        aria-hidden="true"
                      />
                    </div>
                  </div>
      ...
      <section aria-labelledby="related-products-heading" class="bg-white">
        <div class="mx-auto max-w-2xl px-4 py-24 lg:max-w-7xl lg:px-8 sm:px-6">
          ...
          <div class="grid grid-cols-1 mt-6 gap-x-6 gap-y-10 lg:grid-cols-4 sm:grid-cols-2 xl:gap-x-8">
            <div v-for="product in products" :key="product.id" class="group relative">
              <div
                class="aspect-w-1 aspect-h-1 lg:aspect-none min-h-80 w-full overflow-hidden rounded-md bg-gray-200 lg:h-80 group-hover:opacity-75"
              >
                <img
    ...
    <footer aria-labelledby="footer-heading" class="border-t border-gray-200 bg-white">
      ...
      <div class="mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
        <div class="grid grid-cols-2 gap-8 py-20 lg:grid-cols-4 sm:grid-cols-2 sm:gap-y-0">
