...
<template>
  <div class="bg-gray-50">
    ...
    <main>
      ...
      <div class="bg-white">
        <div
          class="mx-auto max-w-2xl px-4 pb-24 pt-16 lg:grid lg:grid-cols-2 lg:max-w-7xl lg:gap-x-8 lg:px-8 sm:px-6 sm:pb-32 sm:pt-24"
        >
          <!-- Product details -->
              ...
              <ol role="list" class="flex items-center space-x-2">
                <li v-for="(breadcrumb, breadcrumbIdx) in product.breadcrumbs" :key="breadcrumb.id">
                  <div class="flex items-center text-sm">
                    ...
                    >{{ breadcrumb.name }}</a>
                    <svg
                      v-if="breadcrumbIdx !== product.breadcrumbs.length - 1" viewBox="0 0 20 20"
          ...
          <!-- Product image -->
          <div class="mt-10 lg:row-span-2 lg:col-start-2 lg:mt-0 lg:self-center">
                ...
                <div class="sm:flex sm:justify-between">
                  ...
                  <RadioGroup v-model="selectedSize">
                    ...
                    <div class="grid grid-cols-1 mt-1 gap-4 sm:grid-cols-2">
                      ...
                      >
                        <div
                          class="relative block cursor-pointer border border-gray-300 rounded-lg p-4 focus:outline-none" :class="[active ? 'ring-2 ring-indigo-500' : '']"
                        >
      ...
      <div class="mx-auto max-w-2xl px-4 py-24 lg:max-w-7xl lg:px-8 sm:px-6 sm:py-32">
        <!-- Details section -->
          ...
          <div class="grid grid-cols-1 mt-16 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
            <div>
              ...
              <p class="mt-8 text-base text-gray-500">
                ...
                chips, 1,220 standard gumballs, or any combination of on-the-go treats that your heart desires. Yes, we
                did the math.
              </p>
            </div>
            <div>
        ...
        <section aria-labelledby="policy-heading" class="mt-16 lg:mt-24">
          <h2 id="policy-heading" class="sr-only">
            Our policies
          </h2>
          <div class="grid grid-cols-1 gap-y-12 lg:grid-cols-4 sm:grid-cols-2 lg:gap-x-8 sm:gap-x-6">
      ...
      <section aria-labelledby="reviews-heading" class="bg-white">
        <div
          class="mx-auto max-w-2xl px-4 py-24 lg:grid lg:grid-cols-12 lg:max-w-7xl lg:gap-x-8 lg:px-8 lg:py-32 sm:px-6"
        >
