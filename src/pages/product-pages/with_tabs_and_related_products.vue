...
<template>
  <div class="bg-white">
          ...
          >
            <DialogPanel class="relative max-w-xs w-full flex flex-col overflow-y-auto bg-white pb-12 shadow-xl">
              ...
              <div class="border-t border-gray-200 px-4 py-6 space-y-6">
                ...
                <div class="flow-root">
                  <a href="#" class="block p-2 font-medium text-gray-900 -m-2">Create account</a>
                </div>
              </div>
    ...
    <header class="relative bg-white">
      <p class="h-10 flex items-center justify-center bg-indigo-600 px-4 text-sm font-medium text-white lg:px-8 sm:px-6">
                      ...
                      <div class="relative bg-white">
                        <div class="mx-auto max-w-7xl px-8">
                          <div class="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                            <div class="grid col-start-2 grid-cols-2 gap-x-8">
                              <div
                                v-for="item in category.featured" :key="item.name"
                            ...
                            <div class="grid row-start-1 grid-cols-3 gap-x-8 gap-y-10 text-sm">
                              <div v-for="section in category.sections" :key="section.name">
                                <p :id="`${section.id}-heading`" class="font-medium text-gray-900">
                                  {{ section.name }}
                                </p>
                                <ul
                                  role="list" :aria-labelledby="`${section.id}-heading`"
    ...
    <main class="mx-auto px-4 pb-24 pt-14 lg:max-w-7xl lg:px-8 sm:px-6 sm:pb-32 sm:pt-16">
      <!-- Product -->
      <div class="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
        ...
        <!-- Product details -->
        <div class="mx-auto mt-14 max-w-2xl lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 sm:mt-16 lg:max-w-none">
          <div class="flex flex-col-reverse">
            <div class="mt-4">
              ...
              <p class="mt-2 text-sm text-gray-500">
                Version {{ product.version.name }} (Updated <time
          ...
          <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-4 sm:grid-cols-2">
            <button
              type="button"
              class="w-full flex items-center justify-center border border-transparent rounded-md bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:ring-offset-gray-50"
            >
              Pay
              {{ product.price }}
            </button>
            <button
              type="button"
              class="w-full flex items-center justify-center border border-transparent rounded-md bg-indigo-50 px-8 py-3 text-base font-medium text-indigo-700 hover:bg-indigo-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:ring-offset-gray-50"
            >
              Preview
            </button>
          </div>
          ...
          <div class="mt-10 border-t border-gray-200 pt-10">
            ...
            <ul role="list" class="mt-4 flex items-center space-x-6">
              <li>
                <a href="#" class="h-6 w-6 flex items-center justify-center text-gray-400 hover:text-gray-500">
        ...
        <div class="mx-auto mt-16 max-w-2xl w-full lg:col-span-4 lg:mt-0 lg:max-w-none">
          <TabGroup as="div">
            <div class="border-b border-gray-200">
              <TabList class="flex -mb-px space-x-8">
                <Tab v-slot="{ selected }" as="template">
                  <button
                    class="whitespace-nowrap border-b-2 py-6 text-sm font-medium" :class="[selected ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-700 hover:text-gray-800 hover:border-gray-300']"
                  >
                    Customer
                    Reviews
                  </button>
            ...
            <TabPanels as="template">
              <TabPanel class="-mb-10">
                ...
                <div
                  v-for="(review, reviewIdx) in reviews.featured" :key="review.id"
                ...
                >
                  ...
                  <div class="flex-1 py-10" :class="[reviewIdx === 0 ? '' : 'border-t border-gray-200']">
                    ...
                    <div class="prose-sm mt-4 max-w-none text-gray-500 prose" v-html="review.content" />
                  </div>
                </div>
              </TabPanel>
              ...
              <TabPanel class="text-sm text-gray-500">
                ...
                <dl>
                  <template v-for="faq in faqs" :key="faq.question">
                    ...
                    <dd class="prose-sm mt-2 max-w-none text-gray-500 prose">
                      <p>{{ faq.answer }}</p>
                    </dd>
                  </template>
                </dl>
              ...
              <TabPanel class="pt-10">
                ...
                <div class="prose-sm max-w-none text-gray-500 prose" v-html="license.content" />
              </TabPanel>
            </TabPanels>
          </TabGroup>
        </div>
      ...
      <div class="mx-auto mt-24 max-w-2xl sm:mt-32 lg:max-w-none">
        ...
        <div class="grid grid-cols-1 mt-6 gap-x-8 gap-y-8 lg:grid-cols-4 sm:grid-cols-2 sm:gap-y-10">
    ...
    <footer aria-labelledby="footer-heading" class="bg-gray-50">
      ...
      <div class="mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
        <div class="grid grid-cols-1 py-20 md:auto-rows-min md:grid-flow-col md:grid-cols-12 md:gap-x-8 md:gap-y-16">
          <!-- Image section -->
          ...
          >
            ...
            <form class="mt-3 lg:block sm:flex xl:flex">
              <label for="email-address" class="sr-only">Email address</label>
              <input
                id="email-address" type="text" autocomplete="email" required=""
                class="block w-full border border-gray-300 rounded-md bg-white px-4 py-2 text-base text-gray-900 shadow-sm lg:max-w-none sm:max-w-xs sm:min-w-0 sm:flex-1 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 placeholder-gray-500"
              >
              <div class="mt-4 lg:ml-0 lg:mt-4 sm:ml-4 sm:mt-0 xl:ml-4 xl:mt-0 sm:flex-shrink-0">
                <button
                  type="submit"
