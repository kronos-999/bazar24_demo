...
<template>
  <div class="bg-white">
    <header class="flex items-center justify-between px-4 py-10 lg:px-8 sm:px-6 sm:py-8">
      <a href="#">
    ...
    <main class="mx-auto max-w-7xl px-4 pb-16 pt-4 lg:px-8 sm:px-6 xl:px-2 sm:pb-24 sm:pt-8 xl:pt-14">
      <h1 class="sr-only">
        Checkout
      </h1>

      <div class="grid grid-cols-1 mx-auto max-w-lg gap-x-8 gap-y-16 lg:grid-cols-2 lg:max-w-none">
          ...
          <div class="flow-root">
            <ul role="list" class="-my-6 divide-y divide-gray-200">
              <li v-for="product in products" :key="product.id" class="flex py-6 space-x-6">
                ...
                >
                <div class="flex-auto">
                  <div class="sm:flex sm:items-start sm:justify-between space-y-1 sm:space-x-6">
        ...
        <div class="mx-auto max-w-lg w-full">
          ...
          <form class="mt-6">
            ...
            <div class="mt-6 flex space-x-2">
              ...
              <label for="terms" class="text-sm text-gray-500">I have read the terms and conditions and agree to the sale
                of my personal information to the highest bidder.</label>
            </div>

            <button
              type="submit" disabled=""
              class="mt-6 w-full border border-transparent rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm disabled:cursor-not-allowed disabled:bg-gray-100 hover:bg-indigo-700 disabled:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Continue
            </button>
          </form>

          <div class="mt-10 border-b border-t border-gray-200 divide-y divide-gray-200">
            <button
