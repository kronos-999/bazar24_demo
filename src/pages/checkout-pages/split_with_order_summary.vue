...
<template>
  <div class="bg-white">
    ...
    <header
      class="relative mx-auto max-w-7xl bg-indigo-900 py-6 lg:grid lg:grid-cols-2 lg:gap-x-16 lg:bg-transparent lg:px-8 lg:pb-10 lg:pt-16"
    >
      <div class="mx-auto max-w-2xl flex px-4 lg:max-w-lg lg:w-full lg:px-0">
        <a href="#">
          <span class="sr-only">Your Company</span>
          <img
            src="https://tailwindui.com/img/logos/mark.svg?color=indigo&amp;shade=300" alt=""
    ...
    <main class="relative grid grid-cols-1 mx-auto max-w-7xl gap-x-16 lg:grid-cols-2 lg:px-8">
      <h1 class="sr-only">
        Checkout
      </h1>
      ...
      <section
        ...
        class="bg-indigo-900 pb-12 pt-6 text-indigo-300 lg:col-start-2 lg:row-start-1 lg:mx-auto lg:max-w-lg lg:w-full lg:bg-transparent lg:px-0 md:px-10 lg:pb-24 lg:pt-0"
      >
        <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
          ...
          <dl class="border-t border-white border-opacity-10 pt-6 text-sm font-medium space-y-6">
      ...
      <section
        ...
        class="py-16 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:max-w-lg lg:w-full lg:pb-24 lg:pt-0"
      >
          ...
          <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
            ...
            <div class="mt-10">
              ...
              <div class="mt-6 flex items-center">
                ...
                >
                <div class="ml-2">
                  <label for="same-as-shipping" class="text-sm font-medium text-gray-900">Same as shipping
                    information</label>
                </div>
              </div>
            </div>
