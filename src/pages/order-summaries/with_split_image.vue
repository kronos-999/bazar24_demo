...
<template>
  ...
  <main class="relative lg:min-h-full">
    <div class="h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12">
      <img
        src="https://tailwindui.com/img/ecommerce-images/confirmation-page-06-hero.jpg" alt="TODO"
    ...
    <div>
      <div
        class="mx-auto max-w-2xl px-4 py-16 lg:grid lg:grid-cols-2 lg:max-w-7xl lg:gap-x-8 xl:gap-x-24 lg:px-8 lg:py-32 sm:px-6 sm:py-24"
      >
        <div class="lg:col-start-2">
          ...
          <ul
            role="list"
            class="mt-6 border-t border-gray-200 text-sm font-medium text-gray-500 divide-y divide-gray-200"
          >
          ...
          <dl class="border-t border-gray-200 pt-6 text-sm font-medium text-gray-500 space-y-6">
          ...
          <dl class="grid grid-cols-2 mt-16 gap-x-4 text-sm text-gray-600">
            <div>
            ...
            <div>
              ...
              <dd class="mt-2 sm:flex space-y-2 sm:space-x-4 sm:space-y-0">
                <div class="flex-none">
                  <svg
