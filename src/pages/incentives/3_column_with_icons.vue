...
<template>
  <div class="bg-white">
    ...
    <div class="flex overflow-x-auto">
      <div class="mx-auto flex whitespace-nowrap px-4 py-3 space-x-12 lg:px-8 sm:px-6 lg:space-x-24">
        <div
